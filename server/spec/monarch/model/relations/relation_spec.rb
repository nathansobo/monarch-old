    ...
    describe Relation do
      ...
      describe "instance methods" do
        ...
        describe "#project" do
          ...
          context "when passed AliasedColumns and Columns" do
            it "returns a Projection with AliasedColumns corresponding to the given concrete_columns" do
              ...
              blog_post_title.should be_an_instance_of(AliasedColumn)
              blog_post_title.column.should == BlogPost[:title]
            end
          end

          context "when passed a Table and a ConcreteColumn" do
            it "returns a Projection with AliasedColumns corresponding to all the concrete_columns in the given table and also the other given concrete_columns" do
              ...
              Blog.table.concrete_columns.each_with_index do |blog_column, index|
                concrete_columns[index].should be_an_instance_of(AliasedColumn)
                concrete_columns[index].column.should == blog_column
              end
              concrete_columns.last.should be_an_instance_of(AliasedColumn)
              concrete_columns.last.column.should == BlogPost[:body]
            end
          end

          context "when passed a subclass of Record and a AliasedColumn" do
            it "returns a Projection with AliasedColumns corresponding to all the concrete_columns in the given record class's table and also the other given concrete_columns" do
